...
def batch_augment_with_mask(images_path:os.PathLike, mask_path:os.PathLike, augmentor:A.Compose=None, target_folder:os.PathLike='augmented', random_choice:float=0.2) -> None:
    """
